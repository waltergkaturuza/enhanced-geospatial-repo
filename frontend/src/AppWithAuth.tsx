...
const StorePage = () => (
  <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <h1 className="text-3xl font-bold text-gray-900 mb-4">Data Store</h1>
    <p className="text-gray-600">Purchase and manage geospatial data products here.</p>
  </div>
);
  ...
  <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <p className="text-gray-600 text-sm mb-4">Monitor system performance and status</p>
